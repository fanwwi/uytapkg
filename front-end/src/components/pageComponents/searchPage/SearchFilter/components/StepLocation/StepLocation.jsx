  ...
  return (
    <div className={styles.step}>
      <div className={styles.header}>
        ...
        <h1>Выберите местоположение объекта</h1>

        <p>
          Укажите страну и точное местоположение недвижимости. Это поможет быстрее найти нужный вариант именно для вас.
        </p>
      </div>
      ...
      <div className={styles.section}>
        <div className={styles.sectionTitle}>
          ...
          <div>
            <label>Страна</label>
            <span>Выберите страну расположения</span>
          </div>
        </div>
